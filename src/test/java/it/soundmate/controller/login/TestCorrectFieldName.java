...
class TestCorrectFieldName {
    ...
    void testWelcomingField() {
        ...
        driver.findElement(By.id("email-field")).sendKeys("pluto@gmail.com");
        driver.findElement(By.id("password-field")).sendKeys("pluto");
        driver.findElement(By.name("login")).click();
        driver.findElement(By.cssSelector("html")).click();
        Assertions.assertEquals("Welcome, Pluto Topolino", driver.findElement(By.id("welcomeUser")).getText());
    }
}
