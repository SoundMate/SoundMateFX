...
<jsp:useBean id="renterRegBean" scope="request" class="it.soundmate.bean.registerbeans.RegisterRenterBean"/>
<jsp:setProperty name="renterRegBean" property="*"/>

<!-- Registration Request -->
<%
    if (request.getParameter("register")!=null) {
        if (!renterRegBean.checkFields())
        {
%>
...
<div class="main">
    ...
    <div class="main-wrapper">
        ...
        <div class="text-main">
            <h3>Join now as a Room Renter</h3>
            <h3>Let bands and musicians enjoy their music. You make the price.</h3>
        </div>
        ...
        <div class="specific-form">
            ...
            <form action="" method="post" name="signUpForm">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" id="name-field" placeholder="Name"> <br>
                </div>
                <div class="form-group">
                    <label for="address-field">Address</label> <br>
                    <input type="text" name="address" id="address-field" placeholder="str Of The Music, 11"> <br>
                </div>
                <div class="form-group">
