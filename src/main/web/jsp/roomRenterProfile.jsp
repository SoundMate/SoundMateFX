...
<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav mr-auto">
            ...
            <li class="nav-item">
                <a class="nav-link" href="home.jsp">Room</a>
            </li>
            <li class="nav-item">
                <a class="nav-link" href="messages.jsp">Booking</a>
            </li>
            <li class="nav-item">
        ...
        <div class="bg-black shadow rounded overflow-hidden">
            <div class="px-4 pt-0 pb-4 cover">
                <div class="media align-items-end profile-head">
                    ...
                    <%--                        <h4 class="mt-0 mb-0"><%System.out.println(band.getBandName();%></h4>  <!--Non funziona così-->--%>
                    <%--                        <p class="small mb-4"> <em class="fas fa-map-marker-alt mr-2"></em><%System.out.println(band.getCity());%></p>--%>
                    <%--                    </div>--%>
                </div>
            </div>
