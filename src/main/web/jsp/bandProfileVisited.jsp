...
<%@ page import="it.soundmate.controller.logic.ApplicationController" %><%--
  ~ Copyright (c) 2021.
  ~ Created by Lorenzo Pantano on 09/02/21, 16:53
  ~ Last edited: 09/02/21, 16:53
  --%>
...
<%
    BandResultBean band = (BandResultBean) session.getAttribute("bandVisitedUser");
        ...
        <div class="bg-black shadow rounded overflow-hidden">
            ...
            <div class="bg-light p-4 d-flex justify-content-start text-center">
                <ul class="list-inline mb-0">
                    <c:forEach items="${band.genreList}" var="genre">
